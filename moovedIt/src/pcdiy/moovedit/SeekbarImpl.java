...
public class SeekbarImpl extends Preference implements OnSeekBarChangeListener {
    ...
    public SeekbarImpl(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initPreference(Context context, AttributeSet attrs) {
        ...
        setWidgetLayoutResource(R.layout.compound_seekbar);
    }
